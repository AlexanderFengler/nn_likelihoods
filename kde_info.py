...
"ddm":{
    ...
    "param_bounds_sampler": [[-2.7, 2.7], [0.4, 2.2], [0.15, 0.85], [0.05, 1.95]],
...
"ddm_sdv_analytic":{
    ...
    "param_bounds_sampler": [[-2.7, 2.7], [0.5, 2.2], [0.15, 0.85], [0.05, 1.95], [0.3, 2.2]],
...
"ddm_sdv_red_analytic":{
    ...
    "param_names": ["v", "a", "w", "ndt", "sdv"],
    "boundary_param_names": [],
    "param_bounds_network": [[-2.5, 2.5], [0.5, 2.5], [0.2, 0.8], [0.0, 2.0], [0.0, 2.0]],
    "param_bounds_sampler": [[-2.2, 2.2], [0.6, 2.2], [0.25, 0.75], [0.05, 1.95], [0.3, 1.7]],
    "param_bounds_cnn": [[-3, 3], [0.3, 2.5], [0.1, 0.9], [0.0, 2.0], [0.0, 2.5]],
    "boundary_param_bounds_network": [],
    "boundary_param_bounds_sampler": [],
    "boundary_param_bounds_cnn": [],
...
"full_ddm2":{
    ...
    "boundary_param_names": [],
    # "param_bounds_network": [[-2.0, 2.0], [0.6, 1.8], [0.3, 0.7], [0.25, 1.25], [0, 0.4], [0, 0.5], [0.0, 0.5]],
    "param_bounds_network": [[-3, 3], [0.3, 2], [0.3, 0.7], [0.25, 2.25], [0.0, 0.3], [0.0, 2.0], [0.0, 0.25]],
    "param_bounds_sampler": [[-2.5, 2.5], [0.4, 1.8], [0.25, 0.65], [0.3, 2.2], [0.05, 0.25], [0.3, 1.7], [0.05, 0.2]],
    "param_bounds_cnn": [[-3.0, 3.0], [0.3, 2.0], [0.3, 0.7], [0.25, 2.25], [0.0, 0.4], [0.0, 2.0], [0.0, 0.25]],
    "boundary_param_bounds_network": [],
    "boundary_param_bounds_sampler": [],
    "boundary_param_bounds_cnn": [],
    "dgp_hyperparameters": [['s', 1.0], 
