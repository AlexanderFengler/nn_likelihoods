...
declare -a dgps=( "ddm_seq2_angle" "ddm_mic2_angle" "ddm_par2_angle" ) 
n_samples=( 1000 )   # ( 128 256 512 1024 2048 4096 8192 50000 100000 200000 400000 )
n_choices=( 2 ) #( 4 5 6 )
        ...
        do
            ...
            then
                for n_c in "${n_choices[@]}"
                 ...
                 echo "$dgp"
                 #echo $n_c
                 python -u dataset_generator.py --machine $machine --dgplist $dgp --datatype $datatype --nreps 1 --binned 1 --nbins $bins --maxt $maxt --nchoices ${n_choices[0]} --nsamples $n --mode cnn --nparamsets $n_parameter_sets --save 1  --deltat 0.001 --fileid 999 #$SLURM_ARRAY_TASK_ID
