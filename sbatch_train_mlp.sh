...
if [ $analytic -eq 1 ]; then
    ...
    do
       ...
       python -u /users/afengler/git_repos/nn_likelihoods/keras_fit_model.py --machine $machine --method $method --nfiles $nfiles --maxidfiles $maxidfiles --datafolder /users/afengler/data/analytic/${method}/training_data_binned_0_nbins_0_n_100000/ --nbydataset 10000000 --warmstart 0 --analytic $analytic
    done
else
    for i in {1..1}
    do
       echo "Now starting run: $i"
       python -u /users/afengler/git_repos/nn_likelihoods/keras_fit_model.py --machine $machine --method $method --nfiles $nfiles --maxidfiles $maxidfiles --datafolder /users/afengler/data/kde/${method}/training_data_binned_0_nbins_0_n_100000/ --nbydataset 10000000 --warmstart 0 --analytic $analytic
    done
